...
public class ChatActivity extends AppCompatActivity {
            ...
            if (FirebaseAuth.getInstance().getCurrentUser() == null) {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot group : dataSnapshot.getChildren()) {
                            ...
                            if (Objects.requireNonNull(group.getValue(GroupItem.class)).getPeopleInGroup().contains(FirebaseAuth.getInstance().getCurrentUser().getEmail())) {
                                ...
                                FirebaseMessaging.getInstance().subscribeToTopic(String.valueOf(Objects.requireNonNull(group.getValue(GroupItem.class)).getGroupTitle()));
                ...
                sendButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        input.setText(intentAction.getStringExtra("textToShare"));
                                ...
                                messageToSend.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        for (DataSnapshot childHeaders : dataSnapshot.getChildren()) {
                                            ...
                                            Toast.makeText(ChatActivity.this, "Yay!! Message Sent! :)", Toast.LENGTH_LONG).show();
    ...
    private void sendNotifications(){
        ...
        ComponentName component = new ComponentName(ChatActivity.this, NotificationSender.class);
        JobInfo jobInfo = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            jobInfo = new JobInfo.Builder(new Random().nextInt(3000), component)
        ...
        if(resultCode == JobScheduler.RESULT_SUCCESS){
            ...
            Toast.makeText(ChatActivity.this, "Sorry, your friends could not be notified of this message! :(",Toast.LENGTH_LONG).show();
        }

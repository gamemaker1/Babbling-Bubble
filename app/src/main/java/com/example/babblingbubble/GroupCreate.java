    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addGroupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                long groupId = UUID.randomUUID().getMostSignificantBits();

                // Read the fields and push a new instance
                // of GroupItem to the Firebase database

                if (bubbleNameEditText.getText().toString().trim().length() > 1 && personNameEditText.getText().toString().trim().length() > 0 && emailRegex.matcher(personNameEditText.getText().toString()).matches() && bnameRegex.matcher(bubbleNameEditText.getText().toString()).matches()) {
                    ...
                    FirebaseMessaging.getInstance().subscribeToTopic(bubbleName)
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for (DataSnapshot childHeaders : dataSnapshot.getChildren()) {
                                ...
                                FirebaseDatabase.getInstance()
                                        ...
                                        .push()
                                        .setValue(new ChatMessage("I have created this group!",
